...
import { Accordions, Banner, DynamicApiProvider, GridItemArea, Cookies, ImagePlusText, Midia, Page404, Paragraph, Products, StorefrontFooter, StorefrontHeader, StorefrontMenu, ThemeContext } from "w3block-new-lib";
...
export const StorefrontPreview = ({ children }: StorefrontPreviewProps) => {
  const context: any = useContext(ThemeContext as any);
